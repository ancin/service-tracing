...
public class TraceFilter implements Filter {
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        logger.info(
            "hashCode-->" + this.hashCode() + "\tthreadID-->" + Thread.currentThread().getId());
        ...
        if (IS_CONSUMER) {
            ...
            if (null == traceBean) {
                 ...
                 */
                traceBean = traceHandler.createTracer(TRACE_ID,
                    traceHandler.getSpanID(TRACE_ID, jedisCluster), traceBean.getSpanId(), HOST,
                    PORT, SERVICE_NAME, METHOD_NAME);
            }
        ...
        if (IS_PROVIDER) {
            ...
            final Integer PARENT_SPAN_ID = Integer
                .parseInt(rpcInvocation.getAttachment("parentSpanID"));
            traceBean = traceHandler.createTracer(TRACE_ID, SPAN_ID, PARENT_SPAN_ID, HOST, PORT,
